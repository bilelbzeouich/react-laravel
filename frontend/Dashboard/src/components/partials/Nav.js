            ...
            <ul class="navbar-nav ms-auto me-3 me-lg-4 align-items-center">
                ...
                <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    <li className="nav-item dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style={{ backgroundColor: 'white' }}>
                            {product.map((product) => (
                                <li key={product.id}>
                                    <a className="dropdown-item" href="/EtatStock">
                                        <p>Produit : {product.nom} - Quantité faible</p>
                                    </a>
                                </li>
                            ))}
                            {date && date.length > 0 ? (
                                date.map((product) => (
                                    <li key={product.id}>
                                        <a className="dropdown-item" href="/EtatStock">
                                            <p>Produit : {product.nom} - Date d'expiration : Il reste moins de 30 jours</p>
