...
const AddClient = () => {
    ...
    const hundleClientCreate = async (e) => {
        e.preventDefault();


        try {

            axios.put(Constants.BASE_URL + `/clients/${clientId}`, input).then(res => {
    ...
    useEffect(() => {
        axios.get(Constants.BASE_URL + `/clients/${clientId}`)
            .then(response => {
                                    ...
                                    <div className='row justify-content-center'>
                                        <div className='col-md-4'>
                                            <div className='d-grid mt-4'>
                                                <button onClick={hundleClientCreate} className='btn btn-outline-success'>Editer</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
