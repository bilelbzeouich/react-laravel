...
const AddRecep = () => {
    ...
    const hundleCategoryCreate = () => {
        ...
        axios.put(Constants.BASE_URL + `/produit/${productId}`, input).then(res => {
        ...
        const handleInput = (event) => {
            ...
            if (file) {
                ...
                formData.append('otherField', input.otherField); // Add other fields if needed

                axios.put(`${Constants.BASE_URL}/produit/${productId}`, formData)
                    .then(res => {
                        console.log(res.data);
                    })
                    .catch(errors => {
                                    ...
                                    <div className='row justify-content-center'>
                                        <div className='col-md-4'>
                                            <div className='d-grid mt-4'>
                                                <button type="button" onClick={hundleCategoryCreate} className='btn btn-outline-success'>Ajouter</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
